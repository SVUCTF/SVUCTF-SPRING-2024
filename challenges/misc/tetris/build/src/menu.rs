...
#[derive(Component)]
pub struct OnGameWonMenuScreen;
...
pub fn setup_game_won_menu(mut commands: Commands) {
    let flag: [u8; 19] = [
        156, 150, 155, 157, 129, 178, 206, 153, 145, 174, 146, 201, 174, 201, 142, 136, 147, 137,
        135,
    ];
    commands
        .spawn((
        ...
        .with_children(|parent| {
            parent
                ...
                .with_children(|parent| {
                    ...
                    parent.spawn(
                        TextBundle::from_section(
                            String::from_iter(flag.map(|c| (c ^ 0xfa) as char)),
                            TextStyle {
                                font_size: 25.0,
                                color: Color::rgb(0.9, 0.9, 0.9),
                                ..default()
